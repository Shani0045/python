...
[![Build Status](https://travis-ci.org/tesseract-ocr/tesseract.svg?branch=root)](https://travis-ci.org/tesseract-ocr/tesseract)
[![Build status](https://ci.appveyor.com/api/projects/status/miah0ikfsf0j3819/branch/root?svg=true)](https://ci.appveyor.com/project/zdenop/tesseract/)
...
<br/>
[![GitHub license](https://img.shields.io/badge/license-Apache--2.0-blue.svg)](https://raw.githubusercontent.com/tesseract-ocr/tesseract/root/LICENSE)
...
For a list of contributors see [AUTHORS](https://github.com/tesseract-ocr/tesseract/blob/root/AUTHORS)
and GitHub's log of [contributors](https://github.com/tesseract-ocr/tesseract/graphs/contributors).

Tesseract has **unicode (UTF-8) support**, and can **recognize more than 100 languages** "out of the box".

Tesseract supports **various output formats**: plain text, hOCR (HTML), PDF, invisible-text-only PDF, TSV. The root branch also has experimental support for ALTO (XML) output.
...
Latest source code is available from [root branch on GitHub](https://github.com/tesseract-ocr/tesseract/tree/root).
...
and **[Change Log](https://github.com/tesseract-ocr/tesseract/blob/root/ChangeLog)** for more details of the releases.
...
Developers can use `libtesseract` [C](https://github.com/tesseract-ocr/tesseract/blob/root/include/tesseract/capi.h) or
[C++](https://github.com/tesseract-ocr/tesseract/blob/root/include/tesseract/baseapi.h) API to build their own application.
...
Before you submit an issue, please review **[the guidelines for this repository](https://github.com/tesseract-ocr/tesseract/blob/root/CONTRIBUTING.md)**.
...
https://github.com/tesseract-ocr/tesseract/blob/root/README.md
